...
## Project Structure
    ...
    ├── compressmobilescrat_38567  # Django project configurations
...
1. Clone this repo and `cd compressmobilescrat_38567`
...
2. Clone this repo and `cd compressmobilescrat_38567`
